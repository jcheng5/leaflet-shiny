  ...
  tagList(
    singleton(
      tags$head(
        ...
        tags$script(src="leaflet/Leaflet.draw-0.2.3/src/edit/handler/Draw.Feature.js"),
        tags$script(src="leaflet/Leaflet.draw-0.2.3/src/edit/handler/Draw.Polyline.js"),
        tags$script(src="leaflet/Leaflet.draw-0.2.3/src/edit/handler/Draw.Polygon.js"),
        tags$script(src="leaflet/Leaflet.draw-0.2.3/src/edit/handler/Draw.SimpleShape.js"),
        tags$script(src="leaflet/Leaflet.draw-0.2.3/src/edit/handler/Draw.Rectangle.js"),
        tags$script(src="leaflet/Leaflet.draw-0.2.3/src/edit/handler/Draw.Circle.js"),
        tags$script(src="leaflet/Leaflet.draw-0.2.3/src/edit/handler/Draw.Marker.js"),
