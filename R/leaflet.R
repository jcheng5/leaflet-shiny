  ...
  tagList(
    singleton(
      tags$head(
        ...
        tags$script(src="Leaflet.draw-0.2.3/src/Leaflet.draw.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Edit.Poly.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Edit.SimpleShape.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Edit.Circle.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Edit.Rectangle.js"),

        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Draw.Feature.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Draw.Polyline.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Draw.Polygon.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Draw.SimpleShape.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Draw.Rectangle.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Draw.Circle.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/Draw.Marker.js"),

        tags$script(src="Leaflet.draw-0.2.3/src/ext/LatLngUtil.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/ext/GeometryUtil.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/ext/LineUtil.Intersect.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/ext/Polyline.Intersect.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/ext/Polygon.Intersect.js"),

        tags$script(src="Leaflet.draw-0.2.3/src/Control.Draw.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/Tooltip.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/Toolbar.js"),

        tags$script(src="Leaflet.draw-0.2.3/src/draw/DrawToolbar.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/EditToolbar.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/EditToolbar.Edit.js"),
        tags$script(src="Leaflet.draw-0.2.3/src/edit/handler/EditToolbar.Delete.js"),
